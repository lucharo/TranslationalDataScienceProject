...
lasso.stab = readRDS(paste0(read_data, "NoBiolassoStabCovs1.rds"))
coefs = lasso.stab[[1]]
aucs = lasso.stab[[2]]
quietly(sapply(2:100, FUN =  function(x) {
  file = readRDS(paste0(read_data, "NoBiolassoStabCovs",x,".rds"))
...
replace = c("# of medicines","no_medicines", "Age recruitment" , "age_recruitment 0 0",
            ...
            "Education level" , "qual2", "Alcohol consumption", "alcohol_2", "Female", "gender Female")
